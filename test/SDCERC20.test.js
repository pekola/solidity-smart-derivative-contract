...
//    console.log("Address Counterparty2: %s", counterparty2.address);
  ...
  it.skip("Token Manager mints tokens for two counterparties", async () => {
  ...
  it.skip("Counterparty2 triggers a transfer to counterparty1", async () => {
    expect(await sdcerc20.totalSupply()).to.equal(15);
